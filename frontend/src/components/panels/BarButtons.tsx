...
export default function BarButtons({ onToggleBottomPanel, onToggleDrawing }: BottomButtonsProps) {
    return (
        <div className="flex flex-col absolute top-1/2 right-0 z-50 -translate-x-1/2 buttons-bar">
            <Button onClick={onToggleDrawing} variant="outline" size="icon" className="h-12 w-12 rounded-full border-2 border-red-600 mb-4">
