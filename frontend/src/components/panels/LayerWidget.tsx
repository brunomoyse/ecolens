...
export default function LayerWidget() {
	...
	return (
		<aside id="layer-widget" className="absolute z-20 left-12 top-12 bg-gray-200 rounded-3xl shadow-lg">
			<header
				id="drag-layer-widget"
				className="flex cursor-move justify-between py-4 px-4 bg-gray-300 rounded-t-3xl"
			>
				<div className="flex">
								...
								<div key={baseLayer.get('title')}>
									...
									<div className="mb-2">
										...
										{baseLayer.getVisible() &&
											findLegend(baseLayer)?.layers[0].legend.map((legendItem) => (
												<div
													key={legendItem.url}
													className="flex items-center ml-2 pl-2 border-l-2 border-l-black "
												>
													...
													<span className="ml-2 text-sm">{legendItem.label}</span>
												</div>
											))}
										{/* Enterprise legends */}
										{baseLayer.get('title') === 'Entreprises' && baseLayer.getVisible() && (
											<>
												...
												<div className="flex items-center ml-2 pl-2 border-l-2 border-l-black ">
													...
													<span className="ml-2 text-sm">Secteur primaire</span>
												</div>
												{/* Secondary sector */}
												<div className="flex items-center ml-2 pl-2 border-l-2 border-l-black ">
													<div className="flex flex-col justify-center">
													...
													<span className="ml-2 text-sm">Secteur secondaire</span>
												</div>
												{/* Tertiary sector */}
												<div className="flex items-center ml-2 pl-2 border-l-2 border-l-black ">
													<div className="flex flex-col justify-center">
													...
													<span className="ml-2 text-sm">Secteur tertiaire</span>
												</div>
												{/* Unknown sector */}
												<div className="flex items-center ml-2 pl-2 border-l-2 border-l-black ">
													<div className="flex flex-col justify-center">
													...
													<span className="ml-2 text-sm">Secteur inconnu</span>
												</div>
											</>
										)}
										...
										{baseLayer.get('title') === 'Cadastre' && baseLayer.getVisible() && (
											<>
												<div className="flex items-center ml-2 pl-2 border-l-2 border-l-black ">
													<div className="flex flex-col justify-center">
														<div className="w-5 h-5 bg-transparent ring-2 ring-black ring-inset flex items-center justify-center" />
													</div>
													<span className="ml-2 text-sm">Parcelles cadastrales</span>
												</div>
											</>
										)}
										{/* Délimitation intercommunales */}
										{baseLayer.get('title') === 'Délimitation intercommunales' &&
											baseLayer.getVisible() && (
												<>
													<div className="flex items-center ml-2 pl-2 border-l-2 border-l-black ">
														<div className="flex flex-col justify-center">
														...
														<span className="ml-2 text-sm">Limites intercommunales</span>
													</div>
												</>
											)}
									</div>
								...
								<SelectContent>
									{subCategories.map((subCategory) => (
										<SelectItem
											...
											value={formatSubCategoryName(subCategory.name)}
										>
